...
class JsonRpcServer:
    ...
    def handle_request(self, data):
        ...
        """
        try:
            # Parsear la solicitud JSON /// unmarshalling
    ...
    def start(self):
        ...
        server_socket.listen(5)  # Comienza a escuchar (máximo 5 conexiones en cola) y espera la conexion del skeleton 
        ...
        while True:
            ...
            if data:
                ...
                response = self.handle_request(data) # Maneja la solicitud y obtiene la respuesta
                
                client_socket.sendall(response.encode("utf-8")) # Envía la respuesta al cliente
